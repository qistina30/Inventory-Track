...
@section('content')
    <div class="container">
        <h1 class="text-center mb-4" style="color: red;">Edit Category</h1>
                ...
                <form action="{{ route('category.update', $category->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-md-end">
                            <button class="btn btn-primary btn-lg rounded-pill me-2" type="submit"><i class="fas fa-save"></i> Update Category</button>
